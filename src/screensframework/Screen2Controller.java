...
public class Screen2Controller implements Initializable, ControlledScreen {
    ...
    public void loadDataFromDatabasePassagiers(ActionEvent actionEvent) {
        ...
        //Set cell value factory to tableview.
        //NB.PropertyValue Factory must be the same with the one set in model class.
        columnidPassagiers.setCellValueFactory(new PropertyValueFactory<>("idPassagiers"));
        columnNaam.setCellValueFactory(new PropertyValueFactory<>("Naam"));
        columnGeboortedatum.setCellValueFactory(new PropertyValueFactory<>("Geboortedatum"));
        columnVluchten_VluchtNummer.setCellValueFactory(new PropertyValueFactory<>("Vluchten_VluchtNummer"));
